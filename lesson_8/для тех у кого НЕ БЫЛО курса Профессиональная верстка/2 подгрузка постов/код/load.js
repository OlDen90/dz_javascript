...
function getPostMarkup(counter) {
    ...
    */
    ...
    //-----------------------------------------------------------------------------------------
    //единственно место где застопорился это - что писать в скобках Date.
    //В остальном всё собрал сам, но постоянно сверялся, не верил в то что всё идет так гладко.
    //-----------------------------------------------------------------------------------------
